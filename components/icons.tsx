...
export const LogoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5-10-5-10 5zM12 12.53l-10-5 .75-.38L12 11.5l9.25-4.35.75.38-10 5z"></path>
    </svg>
);
...
export const GoogleAiIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM8.5 15.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm5-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm4 3a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" />
    </svg>
);
